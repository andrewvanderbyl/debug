...
args = {varargin{:}};
[input, temp, results(1)]  = utpar_get({args, 'inputs'});
[dvalid, temp, results(1)] = utpar_get({input{3}, 'dvalid'});
[din, temp, results(1)] = utpar_get({input{2}, 'din'});
      ...
      'inputs', { ...
        'parameters', { ...
          'ports',  { ... %input port description from model
            ...
            {'dvalid',   {'parallelisation', 1, 'complex', 'off'}}, ...
          }, ... %ports
        }, ... %parameters
      }, ... %inputs
      'outputs', { ...
        'parameters', { ...
          'ports', { ... %output port description from model
            ...
            {'dvalid', {'complex', 'off', 'parallelisation', 1}}, ...
          }, ... %ports
        }, ... %parameters
      }, ... %outputs
    }, ... %blocks
