...
function[dout, result] = casper_pfb_fir_generic_channel_response_dsim(varargin)
  %tic  
  ...
  defaults = { ...
    ...
    'freq_step', 1/15, ...          % frequency step for each iteration in fraction of an fft_bin     1/15
    'span', 5, ...                  % frequency span over which to iterate
  ...
  pfb_fir_model_name    = 'pfb_fir_generic_test_dsim';
