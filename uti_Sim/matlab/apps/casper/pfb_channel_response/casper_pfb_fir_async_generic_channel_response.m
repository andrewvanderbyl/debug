...
function[dout, result] = casper_pfb_fir_async_generic_channel_response(varargin)
  %tic  
  ...
  defaults = { ...
    'n_spectra', 8, ...             % the amount of averaging to perform   (was 8)
    ...
    'freq_step', 1/90, ...          % frequency step for each iteration in fraction of an fft_bin     1/15
  ...
  fft_model_name        = 'fft_async_test_sim4';
