...
function[dout, result] = casper_pfb_fir_generic_channel_response_3(varargin)
  tic  
  ...
  defaults = { ...
    ...
    'span', 6, ...                  % frequency span over which to iterate
  ...
  pfb_fir_model_name    = 'pfb_fir_generic_test_sim3';
