...
if strcmp(block_type, 'fft_wideband_real'),
  if strcmp(block_version, '0') || strcmp(block_version, '1'),
...
if strcmp(block_type, 'fft_wideband_real'),
  if strcmp(block_version, '0') || strcmp(block_version, '1'),
    ...
    outputs = { ...
      ...
      {'dout', {'complex', 'on', 'parallelisation', 2^(n_inputs-1), 'type', 'Signed', 'bit_width', input_bit_width, 'bin_pt', input_bit_width-1 }}, ...
      {'of', {'complex', 'off', 'parallelisation', 1, 'type', 'Boolean', 'bit_width', 1, 'bin_pt', 0}}, ...
      {'dvalid_fft', {'complex', 'off', 'parallelisation', 1, 'type', 'Boolean', 'bit_width', 1, 'bin_pt', 0}}
    }; ... %outputs
  else
