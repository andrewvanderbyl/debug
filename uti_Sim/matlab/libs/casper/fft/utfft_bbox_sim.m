...
[dvalid, temp, results(7)]          = utpar_get({args, 'dvalid'});
...
raw_dvalid_in   = {'dvalid', dvalid};
raw_shift_in    = {'shift', shift};
raw_inputs      = {raw_sync_in, raw_shift_in, raw_data_in, raw_dvalid_in};
...
[dout, en, dvalid, result] = utextract('mux', 2^(n_inputs-1), 'data', raw_dout, 'sync', raw_synco, 'fold_len', 2^(fft_stages-1));
if result ~= 0, 
