...
[async, temp, results(5)]      = utpar_get({parameters, 'async'});
...
if strcmp(type, 'default'),
  ...
  if strcmp(version, '0') && strcmp(async, 'off'),
    %default parameters
    default_params = { ...
        'n_streams', 1, ...
        'PFBSize', 5, ...
  ...
  elseif strcmp(version, '0') && strcmp(async, 'on'),
    %default parameters
    default_params = { ...
        'n_streams', 1, ...
        'PFBSize', 5, ...
...
if strcmp(type, 'default'),
  if strcmp(version, '0'),
    ...
    inputs = { ...
      ...
      {'dvalid', {'complex', 'off', 'parallelisation', 1, 'type', 'Boolean', 'quantization', 'Truncate', 'overflow', 'Flag as error', 'bit_width', 1, 'bin_pt', 0}}, ...
      }; ... %inputs
...
if strcmp(type, 'default'),
  if strcmp(version, '0'),
    ...
    outputs = { ...
      ...
      {'dvalid', {'complex', 'off', 'parallelisation', 1, 'type', 'Boolean', 'bit_width', 1, 'bin_pt', 0}}
    }; ... %outputs
  else
    utlog(['Don''t know about block ',type, ' version ',version],{'error', log_group});
  end %version  
